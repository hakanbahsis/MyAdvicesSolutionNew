       ...
       private NoteManager noteManager = new NoteManager();
        ...
        public ActionResult Index()
        {
            ...
            var notes = noteManager.ListQuaryable()
                .Include("Category").Include("Owner").Where(x => x.Owner.Id == CurrentSession.User.Id)
        ...
        {
           var notes= likedManager.ListQuaryable().Include("LikedUser").Include("Note").Where(
               x => x.LikedUser.Id == CurrentSession.User.Id).Select(
               x => x.Note).Include("Category").Include("Owner").OrderByDescending(x => x.ModifiedOn);
